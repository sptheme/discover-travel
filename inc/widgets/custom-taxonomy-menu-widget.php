...
class WPSP_Custom_Taxonomy_Menu_Widget extends WP_Widget {
    ...
    public function __construct() {
        $id = 'wpsp-custom-taxonomy-menu-widget';
        $name = WPSP_THEME_NAME . ' - '. __( 'Custom Taxonomy Menu', 'wpsp_admin' );
        $widget_ops = array(
                'classname'         => 'widget-tax-nav-menu widget_nav_menu',
                'description'   => __( 'A widget to display simple menu of your custom taxonomies and their associated terms, ideal for sidebars.', 'wpsp_admin' )
            );
        $control_ops = array();
